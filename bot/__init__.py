...
AUTH_BOT_ENABLED = environ.get("AUTH_BOT_ENABLED", "")
AUTH_BOT_ENABLED = AUTH_BOT_ENABLED.lower() == "true"

AUTH_BOT_TOKEN = environ.get("AUTH_BOT_TOKEN", "")
if len(AUTH_BOT_TOKEN) == 0:
    AUTH_BOT_TOKEN = ""

AUTH_BOT_USERNAME = environ.get("AUTH_BOT_USERNAME", "")
if len(AUTH_BOT_USERNAME) == 0:
    AUTH_BOT_USERNAME = ""

AUTH_BOT_TOKEN_SECRET = environ.get("AUTH_BOT_TOKEN_SECRET", "")
if len(AUTH_BOT_TOKEN_SECRET) == 0:
    AUTH_BOT_TOKEN_SECRET = ""
...
config_dict = {
    ...
    "AUTH_BOT_ENABLED": AUTH_BOT_ENABLED,
    "AUTH_BOT_TOKEN": AUTH_BOT_TOKEN,
    "AUTH_BOT_USERNAME": AUTH_BOT_USERNAME,
    "AUTH_BOT_TOKEN_SECRET": AUTH_BOT_TOKEN_SECRET,
}
